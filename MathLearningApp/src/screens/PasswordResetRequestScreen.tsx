...
type PasswordResetRequestScreenProps = NativeStackScreenProps<any, 'PasswordResetRequest'>;
 ...
 */
const PasswordResetRequestScreen: React.FC<PasswordResetRequestScreenProps> = ({
  navigation,
}) => {
  ...
  const handleRequestReset = async () => {
    ...
    try {
      ...
      console.error('[PasswordResetRequestScreen] Request failed:', error);
      setErrors({
