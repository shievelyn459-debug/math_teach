...
describe('FormInput Component', () => {
  describe('FormInput', () => {
    ...
    it('should show inline error with clear button', () => {
      ...
      expect(getByText('This field is required')).toBeTruthy();
      expect(getByTestId('clear-error-icon')).toBeTruthy();
    });
    ...
    it('should apply green border when valid and has value', () => {
      ...
      const input = getByTestId('test-input');
      // Valid input should have the success icon
      expect(input).toBeTruthy();
      // Check if parent container has valid styling
      const parentStyle = input.parent?.props.style;
      expect(parentStyle || input.props.style).toBeDefined();
    });
  });
